...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        console.group('%c Signup Process', 'color: #00ff00; font-weight: bold');
        console.log('1. Starting registration process...');
        console.log('2. Form data:', {
            username: formData.username,
            email: formData.email,
            passwordLength: formData.password.length // Safe way to log password info
        });
        ...
        console.group('%c Signup Error', 'color: #ff0000; font-weight: bold');
        ...
        setIsLoading(false);
        console.log('5. Registration process completed');
        console.groupEnd();
    }
  };
